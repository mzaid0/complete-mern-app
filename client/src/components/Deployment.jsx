        ...
        <div className="bg-white py-10">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    ...
                    data-aos-delay="300"
                    className="text-base font-semibold leading-7 text-indigo-600">Deploy faster</h2>
                    <p 
                    data-aos="zoom-out"
                    data-aos-duration="500"
                    
                    className="mt-2 text-3xl font-extrabold tracking-tight  sm:text-4xl">Everything you need to <span className="text-indigo-500">deploy your app</span> </p>
                    <p 
                    data-aos="zoom-out"
                    data-aos-duration="500"
                    
                    className="mt-6 text-lg leading-8 text-gray-600">Quis tellus eget adipiscing convallis sit sit eget aliquet quis. Suspendisse eget egestas a elementum pulvinar et feugiat blandit at. In mi viverra elit nunc.</p>
                </div>
